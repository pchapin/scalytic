//-----------------------------------------------------------------------
// FILE    : ScalyticInfoComponent.scala
// SUBJECT :
...
/**
 * This class implements a plugin component using tree transformers and InfoTransformer. An InfoTransformer will be
 * automatically created and registered in <code>SymbolTable.infoTransformers</code>. If a <code>Typer</code> is needed
 * during transformation, the component should mix in <code>TypingTransformers</code>. This provides a local variable
 ...
 */
class ScalyticInfoTransformComponent(val global: Global) extends PluginComponent
   ...
   */
  val phaseName = "scalyticinfotransform"
  ...
  /**
   * The type transformation applied by this component. The trait InfoTransform will create an instance of
   * InfoTransformer applying this TypeMap. The type map will be applied when computing a symbol's type in all phases
