...
/**
 * This class shows how to implement a compiler component that can be used in a compiler plugin. If the plugin uses a
 * tree transformer and/or an InfoTransformer, look at the two classes <code>TemplateTransformComponent</code> and
 * <code>TemplateInfoTransformComponent</code>.
 *
 *  @todo Adapt the name of this class to the plugin, and implement it.
 */
class ScalyticComponent(val global: Global) extends PluginComponent {
  import global._
